...
<% 
	...
	out.println("<textarea id = \"name_area\" style = \"overflow:hidden\" readonly = \"readonly\" disabled>자료 작성</textarea><br>");
%>
	<form action="write_material_action.jsp" method = "post">
	<textarea id = "write_section" name = "material" style = "overflow:hidden"></textarea><br><br>
