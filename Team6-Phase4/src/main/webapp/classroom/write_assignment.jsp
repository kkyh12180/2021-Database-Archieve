...
<%
	...
	out.println("<textarea id = \"name_area\" style = \"overflow:hidden\" readonly = \"readonly\" disabled>숙제 작성</textarea><br>");
%>
	<form action="write_assignment_action.jsp" method = "post">
	<textarea id = "write_section" name = "description" style = "overflow:hidden"></textarea><br><br>
