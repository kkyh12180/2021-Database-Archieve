...
<head>
<meta charset="UTF-8">
<title>Write Question Action</title>
</head>
<body>
<%
	...
	int num = 0;
	String query = "SELECT MAX(QuestionNumber) FROM QA WHERE CID = '" + user_class + "'";
	...
	query = "INSERT INTO QA VALUES (" + (num + 1) + ", '" + question + "', ' ', '"+ user_class +"', '" + (Integer.parseInt(user_class) - 100000000) + "')";
	...
	pstmt.close();
	conn.close();
	response.sendRedirect("ClassQA.jsp");
%>
</body>
</html>