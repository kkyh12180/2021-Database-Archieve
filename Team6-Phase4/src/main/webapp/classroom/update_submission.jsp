...
<% 
	...
	String query = "SELECT Submission FROM ASSIGNMENT_SUBMISSION WHERE CID = '" + user_class + "' AND StudentNo = '" + user_info + "' AND AssignmentNumber = " + num;
	String submission = "";
...
%>
	<form action="update_submission_action.jsp" method="post">
	<textarea id="write_section" name="submission" style="overflow:hidden">
<% 
