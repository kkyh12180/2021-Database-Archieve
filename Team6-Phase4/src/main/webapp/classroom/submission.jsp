...
<%
	...
	out.println("<textarea id = \"name_area\" style = \"overflow:hidden\" readonly = \"readonly\" disabled>제출하기</textarea><br>");
%>
	<form action="submission_action.jsp" method = "post">
	<textarea id = "write_section" name = "submission" style = "overflow:hidden"></textarea><br><br>
	<input type="hidden" name="no" value="<%out.println(num);%>"/>
	<input id="button" type = "submit" value= "제출하기">
	</form>
<%
	out.println("</div>");
	out.println("</div>");
