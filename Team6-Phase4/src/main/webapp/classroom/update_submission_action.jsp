...
<head>
<meta charset="UTF-8">
<title>Update Submission Action</title>
</head>
<body>
<%
	...
	String query = "UPDATE ASSIGNMENT_SUBMISSION SET Submission = '" + submission + "' WHERE CID = '" + user_class + "' AND StudentNo = '" + user_info + "' AND AssignmentNumber = " + num;
